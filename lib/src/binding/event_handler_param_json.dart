...
class AudioEncodedFrameObserverOnRecordAudioEncodedFrameJson {
  ...
  @JsonKey(name: 'frameBuffer', includeFromJson: true, includeToJson: false)
...
class VideoEncodedFrameObserverOnEncodedVideoFrameReceivedJson {
  ...
  @JsonKey(name: 'uid')
  final int? uid;
  @JsonKey(name: 'imageBuffer', includeFromJson: true, includeToJson: false)
...
class MusicContentCenterEventHandlerOnMusicCollectionResultJson {
  ...
  @JsonKey(name: 'requestId')
  final String? requestId;
  @JsonKey(name: 'result', includeFromJson: true, includeToJson: false)
